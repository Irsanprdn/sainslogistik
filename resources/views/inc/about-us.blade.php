                    ...
                    <div class="swiper-wrapper" >
                        ...
                        <div class="swiper-slide" >
                            <div class="portfolio-wrap">
                                <a href="{{ asset('assets') }}/uploads/image/{{ $as->image }}"  target="_blank" data-gallery="portfolio-gallery-app" class="glightbox"><img src="{{ asset('assets') }}/uploads/image/{{ $as->image }}" class="img-fluid border-radius-25" style="height:419px;width:555px;" ></a>
                            </div>
