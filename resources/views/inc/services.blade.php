    ...
    <div class="nocontainer" data-aos="fade-up">
        <div class="row">
            <div class="col-lg-5 mb-3 offset-1">
                <h4 class="border-bottom border-warning our-services-yellow-text">Our Services</h4>
                <h1 class="text-dark font-weight-bold font-size-50" id="placeCaptionTitle">SCM</h1>
                <p class="text-justify" id="placeCaptionDescription">
                    Integrated Supply Chain Management (SCM) melibatkan berbagai aspek seperti transportasi, penanganan material, dan manajemen pergudangan.
                </p>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="caption d-none">
                                <p class="caption-title">SCM</p>
                                <p class="caption-desc">Integrated Supply Chain Management (SCM) melibatkan berbagai aspek seperti transportasi, penanganan material, dan manajemen pergudangan.</p>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="portfolio-wrap">
