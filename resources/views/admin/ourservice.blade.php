...
<div class="container">
                    ...
                    <div class="section-title">
                        <div class="d-flex justify-content-start">
                            <h1 class="text-dark font-weight-bold title-question">
                                <input type="text" data-lang="id" id="ourserviceTitle" name="ourserviceTitle" value="{{ $ourserviceTitle->isi_komponen ?? '' }}" class="form-custom form-custom-lg text-dark font-weight-bold title-question reset-setting" readonly>
                            </h1>
                            <button type="button" class=" mx-2 btn btn-warning btn-circle text-light mt-4" onclick="editText(this,'#ourserviceTitle')" title="Clik to edit">
            ...
            <section id="ourservice" class="ourservice">
                <div class="container position-realtive" style="z-index: 300;">
                    ...
                    <div class="section-title">
                        <div class="d-flex justify-content-start">
                            <h1 class="text-dark font-weight-bold title-question">
                                <input type="text" data-lang="en" id="ourserviceTitleen" name="ourserviceTitle" value="{{ $ourserviceTitleEN->isi_komponen ?? '' }}" class="form-custom form-custom-lg text-dark font-weight-bold title-question reset-setting" readonly>
                            </h1>
                            <button type="button" class=" mx-2 btn btn-warning btn-circle text-light mt-4" onclick="editText(this,'#ourserviceTitleen')" title="Clik to edit">
                                <i class="bi bi-pencil"></i>
                            </button>
                        </div>
                        <div class="row d-flex justify-content-start">
    ...
    <script>
        ...
        function saveText(e) {
            ...
            var komponen = "";
            if (lang == 'id') {
                komponen = (e == '#ourserviceTitle' ? 'title' : 'description')
            } else {
                komponen = (e == '#ourserviceTitleen' ? 'title' : 'description')
            }
            var data = {
                _token: '{{ csrf_token() }}',
                menu: 'ourservice',
