...
<div class="container">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="id" role="tabpanel" aria-labelledby="id-tab">
            <section id="linkedinmedia" class="linkedinmedia">
                <div class="container position-realtive" style="z-index: 300;">

                    <div class="section-title">
                        <div class="d-flex justify-content-start">
                            <h1 class="text-dark font-weight-bold title-question">
                                <input type="text" data-lang="id" id="linkedinmediaTitle" name="linkedinmediaTitle" value="{{ $linkedinmediaTitle->isi_komponen ?? '' }}" class="form-custom form-custom-lg text-dark font-weight-bold title-question reset-setting" readonly>
                            </h1>
                            <button type="button" class=" mx-2 btn btn-warning btn-circle text-light mt-4" onclick="editText(this,'#linkedinmediaTitle')" title="Clik to edit">
                        ...
                        <div class="row d-flex justify-content-start">
                            <div class="col-md-10">
                                ...
                                {{ $linkedinmediaDescription->isi_komponen ?? '' }}
                                </textarea>
                            </div>
                            <div class="col-md-2">
            ...
            <section id="linkedinmedia" class="linkedinmedia">
                <div class="container position-realtive" style="z-index: 300;">
                    ...
                    <div class="section-title">
                        <div class="d-flex justify-content-start">
                            <h1 class="text-dark font-weight-bold title-question">
                                <input type="text" data-lang="en" id="linkedinmediaTitleen" name="linkedinmediaTitle" value="{{ $linkedinmediaTitleEN->isi_komponen ?? '' }}" class="form-custom form-custom-lg text-dark font-weight-bold title-question reset-setting" readonly>
                            </h1>
                            <button type="button" class=" mx-2 btn btn-warning btn-circle text-light mt-4" onclick="editText(this,'#linkedinmediaTitleen')" title="Clik to edit">
                                <i class="bi bi-pencil"></i>
                            </button>
                        </div>
                        <div class="row d-flex justify-content-start">
                            <div class="col-md-10">
                                ...
                                {{ $linkedinmediaDescriptionEN->isi_komponen ?? '' }}
                                </textarea>
                            </div>
                            <div class="col-md-2">
    ...
    <script>
        ...
        function saveText(e) {
            ...
            var komponen = "";
            if (lang == 'id') {
                komponen = (e == '#linkedinmediaTitle' ? 'title' : 'description')
            } else {
                komponen = (e == '#linkedinmediaTitleen' ? 'title' : 'description')
            }
            var data = {
                _token: '{{ csrf_token() }}',
                menu: 'linkedinmedia',
