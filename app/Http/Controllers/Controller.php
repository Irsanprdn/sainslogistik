...
class Controller extends BaseController
{
    ...
    public function compro()
    {
        ...
        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'home' and komponen = 'walink' ";
        $homeWAlink = collect(DB::select($sql))->first();

        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'home' and komponen = 'logo' ";
        $homeLogo = collect(DB::select($sql))->first();

        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'home' and komponen = 'video' ";
        $homeVideo = collect(DB::select($sql))->first();

        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'footer' and komponen = 'logo' ";
        ...
        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'footer' and komponen = 'address' ";
        $footerAddress = collect(DB::select($sql))->first();

        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'footer' and komponen = 'iglink' ";
        $footerIGlink = collect(DB::select($sql))->first();

        $sql = " SELECT * FROM cms WHERE isi_komponen <> '' AND menu = 'footer' and komponen = 'lilink' ";
